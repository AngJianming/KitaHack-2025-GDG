...
class RestaurantAwardsWidget extends StatefulWidget {
  const RestaurantAwardsWidget({super.key});

  static String routeName = 'RestaurantAwards';
  static String routePath = '/restaurantAwards';

  @override
  State<RestaurantAwardsWidget> createState() => _RestaurantAwardsWidgetState();
}

class _RestaurantAwardsWidgetState extends State<RestaurantAwardsWidget>
    with TickerProviderStateMixin {
  late RestaurantAwardsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestaurantAwardsModel());
